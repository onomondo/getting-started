 ...
 */
   typedef enum
   {
      ...
      ESP_MODEM_EVENT_POWER_DOWN = 5,
      ESP_MODEM_EVENT_ENTER_PSM = 6,
      ESP_MODEM_EVENT_NETWORK_STATUS = 7,
      ESP_MODEM_EVENT_OPERATOR_SELECTION = 8,
      ESP_MODEM_EVENT_PERIODIC_UPDATE = 9
   } esp_modem_event_t;
